//! \file mglnrel.h
//! \brief 定义图形位置关系函数 Line spatial2d relationship
...
/*!
    ...
    \return 在直线的左边时返回true，否则返回false
*/
GEOMAPI bool mgIsLeft2(const Point2d& a, const Point2d& b, const Point2d& pt, const Tol& tol);
...
/*!
    ...
    \return 在直线的左边或线上时返回true，否则返回false
*/
GEOMAPI bool mgIsLeftOn2(const Point2d& a, const Point2d& b, const Point2d& pt, const Tol& tol);
...
/*!
    ...
    \return 在直线上时返回true，否则返回false
*/
GEOMAPI bool mgIsColinear2(const Point2d& a, const Point2d& b, const Point2d& pt, const Tol& tol);
...
*/
GEOMAPI bool mgIsIntersectProp(const Point2d& a, const Point2d& b, const Point2d& c, const Point2d& d);
...
/*!
    ...
    \return 在线段上时返回true，否则返回false
*/
GEOMAPI bool mgIsBetweenLine2(const Point2d& a, const Point2d& b, const Point2d& pt, const Tol& tol);
...
/*!
    ...
    \return 在线段上时返回true，否则返回false
*/
GEOMAPI bool mgIsBetweenLine3(const Point2d& a, const Point2d& b, const Point2d& pt, Point2d* nearpt = NULL);
...
*/
GEOMAPI bool mgIsIntersect(const Point2d& a, const Point2d& b, const Point2d& c, const Point2d& d);
...
/*!
    ...
    \return 独立点到垂足的距离
*/
GEOMAPI float mgPtToBeeline2(const Point2d& a, const Point2d& b, const Point2d& pt, Point2d& ptPerp);
...
/*!
    ...
    \return 独立点到最近点的距离
*/
GEOMAPI float mgPtToLine(const Point2d& a, const Point2d& b, const Point2d& pt, Point2d& nearpt);
