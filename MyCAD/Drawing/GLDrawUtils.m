...
inline void GLFillRect(CGRect rect)
{
...
inline void GLStrokeRect(CGRect rect)
{
...
//    glDrawArrays(GL_LINES, 0, 8);
    ...
    glEnableVertexAttribArray(GLKVertexAttribPosition);
    glVertexAttribPointer(GLKVertexAttribPosition, 2, GL_FLOAT, GL_FALSE, 0, lineVertices);
    glDrawArrays(GL_LINES, 0, 8);
    glDisableVertexAttribArray(GLKVertexAttribPosition);
#else
    glBegin(GL_LINES); 
...
inline void GLFillCircle(CGPoint center, float radius, int sides)
{
...
inline void GLStrokeCircle(CGPoint center, float radius, int sides)
{
...
inline void GLStrokeLine(CGPoint a, CGPoint b)
{
    const GLfloat lineVertices[] = {
        a.x, a.y, b.x, b.y
    };
...
inline void WDGLDrawLineStrip(GLfloat *vertices, NSUInteger count)
{
#if TARGET_OS_IPHONE
    //glVertexPointer(2, GL_FLOAT, 0, vertices);
